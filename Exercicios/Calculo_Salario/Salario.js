 ...
 Para calcular o percentual de imposto segue as aliquotas:
     ...
     Exemplo:
         ...
         Saída:
             2050.00
*/
const { gets, print } = require('./funcaoEx3');
const salarioBruto = gets();
const adicional = gets();

function porcento(salario){
...
function calcular(salario, imposto){
    return salario * (imposto / 100);    
}

function posImposto(salario, desconto, bonus){
 return (salario - desconto) + bonus
}

const salarioLiquido = posImposto(salarioBruto, calcular(salarioBruto, porcento(salarioBruto)),adicional);
